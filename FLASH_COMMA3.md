...
git push origin master-cma-dev3
...
4. **Select branch**: When prompted, choose `master-cma-dev3`
...
cd opendbc_repo
git status
# Expected: On branch master-cma-dev3
...
```bash
cd /data
git clone --branch master-cma-dev3 https://github.com/vibhusapra/openpilot_polestar.git openpilot
cd openpilot
```
...
cd opendbc_repo
git checkout master-cma-dev3
git pull origin master-cma-dev3
cd ..
```
