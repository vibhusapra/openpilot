...
```
https://installer.comma.ai/vibhusapra/openpilot_polestar/master-cma
```
...
# Install your fork
cd /data
curl https://installer.comma.ai/vibhusapra/openpilot_polestar/master-cma | bash
...
- ✅ Branch: `master-cma`
- ✅ Latest commit: "Switch opendbc submodule to vibhusapra fork"
- ✅ Total: 4 new commits from base
...
- ✅ Branch: `master-cma`
- ✅ Latest commit: "Add Polestar 2 support to Volvo CMA platform"
- ✅ Forked from: paper5590/opendbc
...
# 2. Check commit
git log -1 --oneline
# Expected: "Switch opendbc submodule to vibhusapra fork"
